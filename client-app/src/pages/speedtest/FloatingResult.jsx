    ...
    <>
      ...
      >
        <Box display="flex" justifyContent="space-evenly" width="100%">
          {renderInfoBox(isTestEnds ? true : false, downloadIcon, "سرعت دانلود", download, 'mb/s')}
          {renderInfoBox(isTestEnds ? true : false, uploadIcon, "سرعت آپلود", upload, 'mb/s')}
          {renderInfoBox(isTestEnds ? true : false, pingIcon, "پینگ", latency, 'ms')}
        </Box>
        {isTestEnds &&
          <ContainedButton bgColor='#FF8A35' txtColor="#fff" txtHover='#FF8A35' sx={{
            minWidth: '30%'
          }} onClick={() => navigate(0)} >تست مجدد</ContainedButton>
        }
        {!isTestEnds &&
          <Typography>
            برای دریافت اطلاعات بر روی دکمه شروع کلیک کنید.
